...
/// base : "stations"
/// main : {"temp":285.91,"feels_like":285.67,"temp_min":284.89,"temp_max":286.68,"pressure":1010,"humidity":93}
/// visibility : 10000
/// wind : {"speed":1.03,"deg":360}
/// clouds : {"all":100}
/// dt : 1690264767
/// sys : {"type":2,"id":2019646,"country":"GB","sunrise":1690258398,"sunset":1690315226}
/// timezone : 3600
/// id : 2643743
/// name : "London"
/// cod : 200
...
class NewDataModel {
  ...
  NewDataModel.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
NewDataModel copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => NewDataModel(  coord: coord ?? _coord,
